  ...
  return (
    <div className="mt-2 mb-5">
      ...
      <div className="max-w-lg mx-auto border-solid border-2 border-indigo-600 px-8 py-10 rounded-xl shadow-2xl">
        ...
        <fieldset className="flex items-center justify-center mt-10">
          <legend className="text-center text-3xl font-bold">Login With</legend>
          <div className="flex gap-10 mt-6">
            ...
            <div onClick={handleGitHub} className="w-10 h-10 cursor-pointer">
              <img
                className="rounded-full"
                src="https://i.ibb.co/7ycS3sD/github-6980894-1280.png"
                alt=""
              />
            </div>
          </div>
